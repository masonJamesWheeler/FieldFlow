...
import { onMount } from 'svelte';
  ...
  import {getDocs, collection} from 'firebase/firestore';
	import { storeFormation, storePlay, getPlay, getFormation, makePlayFromData} from '../utils/stores';
...
<html data-theme = "emerald">
	<div class="custom-shape-divider-top-1672787896 hidden lg:block">
...
<section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
  <div class="container mx-auto justify-center">
    <div class="mx-4 grid md:grid-cols-2 2xl:grid-cols-3 grid-flow-row">
      <div class = "col-span-1 hidden 2xl:block ">
				<div class = "card bg-indigo-700 h-32 w-80 absolute ml-32 mt-10 z-0 border-4 border-white tracking-tight text-center">
					<h2 class = "ml-20 text-white font-bold mt-6 mr-4"> 'Put something meaningful here from coach deboer if possible!''</h2>
				</div>
			<div class="avatar overflow-x-auto">
				<div class="w-48 rounded-full border-4 border-white">
				  <img class = "z-100" src="https://x2.pac-12.com/cdn/ff/I5u8HH-LbpZzR46g4nKHnnp7AK6BD8hfMSXUZ6epOfY/1638226065/public/styles/crop_16_9_large_1x/public/FB_KD_RELEASE_HERO_2.jpg?itok=XhhdyitE" />
				</div>
			  </div>
			
	  </div>
      <div class="md:col-span-2 px-4 md:px-0">
        <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-10">
          <h2
...
<style>
.custom-shape-divider-top-1672787896 {
    top: 0;
    left: 0;
    width: 100%;
    overflow: hidden;
...
.custom-shape-divider-top-1672787896 svg {
    position: absolute;
    display: block;
